...
# Версия отрисовки — входит в ключ кэша фото. Поднимать при every
# видимой смене картинки (фон, легенда, подпись): кэш сравнивает только
# дату снимка и контур, и после выкатки нового рендера бот иначе честно
# отдаёт старую картинку — снимок-то не менялся. Ровно так фермер
# получил кадр со старым пиксельным фоном через час после того, как
# фон стал архивной картой.
STYLE_VERSION = 2
