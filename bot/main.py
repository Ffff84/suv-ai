...
CROP_EMOJI = {"cotton": "🌱", "winter_wheat": "🌾", "onion": "🧅",
              ...
              # 🌰 — орехового эмодзи нет, каштана в CROPS не предвидится
              # (прецедент 🍠); 🟡 — айва 🍐-дублем выдавала бы себя за
              # соседнюю живую грушу; 🍒 у вишни — дубль по прецеденту
              # 🍑 O'rik/Shaftoli.
              "pepper": "🫑", "walnut": "🌰", "pear": "🍐",
              "quince": "🟡", "sour_cherry": "🍒"}
...
# Порядок — под клавиатуру по 3 в ряд, 10 полных рядов и орех один в
# последнем: зерновые и бобовые, паслёновые вместе, овощи, бахча,
# люцерна и лоза как linear-мост к деревьям, семечковые подряд,
# косточковые подряд, орех — намеренный финал. Внутренних ключей
# (INTERNAL_CROPS) здесь нет: повторный цикл выбирается месяцем сева.
CROP_ORDER = ("cotton", "winter_wheat", "barley", "rice", "maize",
              "soybean", "beans", "mung", "sesame", "onion", "tomato",
              "pepper", "potato", "carrot", "cabbage", "cucumber",
              "melon", "watermelon", "alfalfa", "grape", "apple",
              "pear", "quince", "apricot", "peach", "plum", "cherry",
              "sour_cherry", "pomegranate", "persimmon", "walnut")
